...
<div style="font-family: Arial, sans-serif; background-color: #f6f7f8; padding: 20px;">
  <div style="max-width: 600px; margin: auto; background: #fff; border-radius: 8px; overflow: hidden; border: 1px solid #ddd;">
    ...
    <div style="padding: 24px;">
      ...
      <p>
        Welcome to <strong> Cvest </strong>. We’re pleased to have you join our sports and recreation community.
      </p>
    ...
    <div style="background: #f6f7f8; padding: 12px; text-align: center; font-size: 13px; color: #777;">
      ...
      This email was sent by <strong>Cvest </strong><br>
...
<div style="font-family: Arial, sans-serif; background-color: #f6f7f8; padding: 20px;">
  <div style="max-width: 600px; margin: auto; background: #fff; border-radius: 8px; overflow: hidden; border: 1px solid #ddd;">
    ...
    <div style="padding: 24px;">
      ...
      <p>Welcome to <strong>Cvest </strong>! You’ve just booked a match with us.</p>
      ...
      <p style="margin-top: 20px; text-align: center;">
        <a href="https://www.Cvest.ng/signup"
    ...
    <div style="background: #f6f7f8; padding: 12px; text-align: center; font-size: 13px; color: #777;">
      ...
      Sent by <strong>Cvest </strong>, your trusted place for sports and recreation.
    </div>
  ...
  `;
    ...
    return this.safeSendMail({
      to: email,
      subject: 'Complete Your Registration on Cvest!',
      html,
    });
  }
